...
import com.exiasoft.itsorder.converter.SimpleOrderConverter
...
@XStreamAlias("ORDER")
@XStreamConverter(SimpleOrderConverter::class)
data class SimpleOrderData(
        ...
        @XStreamAsAttribute
        @XStreamAlias("SIDE") @XStreamConverter(BuySellConverter::class)
        ...
        // In ITS5, request use EXCH_CODE adn response uses EXCHANGE_CODE
        @XStreamAsAttribute
        ...
        @XStreamAsAttribute
        @XStreamAlias("ORDER_STATUS") @XStreamConverter(OrderStatusConverter::class)
        override var orderStatus: OrderStatus,

        @XStreamAsAttribute
        @XStreamAlias("CREATE_DATETIME") @XStreamConverter(LocalDateTimeConverter::class)
        override var createDateTime: LocalDateTime,

        @XStreamAsAttribute
        @XStreamAlias("CREATE_TRADE_DATE") @XStreamConverter(LocalDateConverter::class)
        override var createTradeDate: LocalDate,

        @XStreamAsAttribute
        @XStreamAlias("LAST_UPD_DATETIME") @XStreamConverter(LocalDateTimeConverter::class)
        override var updateDateTime: LocalDateTime,

        @XStreamAsAttribute
        @XStreamAlias("LAST_UPD_TRADE_DATE") @XStreamConverter(LocalDateConverter::class)
        ...
        @XStreamAsAttribute
        @XStreamAlias("ARCHIVED_IND")
        var archivedIndicator: Boolean

) : SimpleOrder {

    constructor() : this(
            orderOid = "", orderNumber = "", buySell = BuySell.Buy, tradingAccountCode = "", exchCode = "", exchangeCode = "",
            ...
            rejectReason = null, orderChannelCode = null, archivedIndicator = false
    )
}