...
abstract class BaseDemoServiceImpl<K, T>(val tokenProvider: TokenProvider, val xStreamProvider: XStreamProvider, clazz: Class<T>, additionXStreamClass: List<Class<*>> = emptyList()): BaseServiceIntf<K, T> {
    ...
    abstract fun isEqualsInIdentifier(id: K, obj: T): Boolean

    abstract fun getOid(obj: T): String

    init {
        objectMapper.registerKotlinModule()
        val xStream = xStreamProvider.provideXstream()
        ...
        data = itsMsg.body.doData.content
    ...
    fun createComparator(pageable: Pageable) : Comparator<T> {
